...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset_rev('resources/assets/libs/horizon/img/favicon.png') }}">

    <title>Horizon</title>

    <!-- Style sheets-->
    <link href="https://fonts.googleapis.com/css?family=Nunito" rel="stylesheet">
    <link href="{{ asset_rev('resources/assets/libs/horizon/'.$cssFile) }}" rel="stylesheet">
</head>
<body>
...
<script src="{{ asset_rev('resources/assets/libs/horizon/app.js') }}"></script>
</body>
</html>
